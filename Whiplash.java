...
public class Whiplash {
    ...
    + "Whip-whiplash, one look, give 'em whiplash";
            ...
            System.out.print("Enter Checktext: ");
            String CheckText = input.nextLine();
            int count = 0;
            int index = 0;
            String [] Text = text.split(" ");
            
            while((index = text.indexOf(CheckText, index)) != -1){
            count++;
            index += CheckText.length();
                    }
            System.out.println("This song has " + CheckText +"\t"+ count + " times ");
